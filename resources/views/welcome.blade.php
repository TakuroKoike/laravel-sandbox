            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <div class="mt-6 flex justify-center">
                    <a href="{{ route('generate-pdf') }}"
                        class="rounded-md bg-[#FF2D20] px-4 py-2 text-white transition hover:bg-[#FF2D20]/80 focus:outline-none focus:ring-2 focus:ring-[#FF2D20] focus:ring-offset-2 dark:focus:ring-offset-zinc-900">
                        Download PDF Sample
                    </a>
                </div>
